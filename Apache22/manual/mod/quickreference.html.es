...
<tr><td><a href="mod_rewrite.html#rewritelog">RewriteLog <em>file-path|pipe</em></a></td><td></td><td>sv</td><td>E</td></tr><tr><td class="descr" colspan="4">Sets the name of the file used for logging rewrite engine
processing</td></tr>
